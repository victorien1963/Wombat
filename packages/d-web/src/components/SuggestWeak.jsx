...
function ColorForm({ setting }) {
  ...
  const onDragEnd = (result) => {
    ...
    handleCardResort('weak', result.source.index, result.destination.index)
  }
  const grid = 8
                          ...
                          >
                            ...
                            <Col>
                              <Form.Control
                                ...
                                value={tag}
                                onChange={(e) =>
                                  handleInputChange('weak', index * 5 + i, [
                                    e.target.value,
                                    content,
                                    id,
                                  ])
...
SuggestWeak.propTypes = {
  setting: PropTypes.shape().isRequired,
}

export default SuggestWeak
